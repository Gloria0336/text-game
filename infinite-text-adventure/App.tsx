              ...
              <div className="max-w-4xl mx-auto flex flex-col gap-4">
                <div className="flex gap-3">
                  <textarea 
                    ...
                    placeholder={isMobileDevice() ? "輸入冒險主題或具體想法..." : "輸入冒險主題或具體想法... (Shift+Enter 換行)"}
                    value={inputMessage} 
                    onChange={(e) => setInputMessage(e.target.value)} 
                    onKeyDown={(e) => {
                      // Check for Enter key without Shift. 
                      // If it's a mobile device, do NOT prevent default (let it be a newline).
                      // If it's desktop, prevent default and send.
            ...
            <div className="p-6 md:p-8 bg-rpg-900 border-t border-rpg-700/50 flex-none z-20 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
               <div className="max-w-2xl mx-auto flex gap-4">
                 <textarea 
                    ...
                    placeholder={isMobileDevice() ? "描述你的行動..." : "描述你的行動... (Shift+Enter 換行)"}
                    value={inputMessage} 
                    onChange={(e) => setInputMessage(e.target.value)} 
                    onKeyDown={(e) => {
                      if (e.key === 'Enter' && !e.shiftKey && !isMobileDevice()) {
